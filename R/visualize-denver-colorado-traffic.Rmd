---
layout: single 
title: "Visualizing hourly traffic crime in Denver, Colorado using R, dplyr, and ggplot"
date: 2016-12-06 
authors: [Max Joseph] 
category: [tutorials] 
...
The city of Denver publicly hosts crime data from the past five years in their [open data catalog](https://www.denvergov.org/opendata/dataset/city-and-county-of-denver-crime).
...
p <- accidents %>%
  ...
  xlab("Time of day") + 
  ylab("Density") + 
  ggtitle("Hourly traffic crimes in Denver, Colorado") + 
